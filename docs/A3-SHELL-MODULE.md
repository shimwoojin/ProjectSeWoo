...
| ~~§7-5 세이브 경로 정식화~~ | ✅ 완료 (2026-09-16). `project.godot`의 `custom_user_dir_name="PunchMonkey"` → `%APPDATA%/PunchMonkey/`. 게임명도 2026-09-16 `PunchMonkey` 로 확정(§12, 스팀 검색 중복 없음) — 경로는 그대로다 |
